...
!!!DAPAT 7 UNDER31SCORE ANG NA EDIT MO  ( LINE 34 to 68 PASTE TO COREBABA SWITCH )
!@@@LeafSwitchONLY
config t
...
!
telephony-service
 moh "flash:/en31bacd31music31on31hold.au"
!
application
 service rivanaa flash:app-b-acd-aa-3.0.0.2.tcl
  ...
  param welcome-prompt flash:en31bacd31welcome.au
...
http://docwiki.cisco.com/wiki/Cisco31IOS31Voice31Troubleshooting31and31Monitoring31--31Tcl31IVR31Troubleshooting
...
!
  voice register pool 2
    id mac D040.EFCF.3C45
    number 1 dn 2
    dtmf-relay sip-notify
    username 3275 password 3275
    codec g711ulaw
!
